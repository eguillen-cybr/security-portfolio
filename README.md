...
El Monte, CA &nbsp;|&nbsp; Target Role: SOC Analyst (Tier 1)
emmanuel.guillen.cybr@gmail.com &nbsp;|&nbsp; linkedin.com/in/emmanuel-guillen-cybr

---

## About This Portfolio

31 independent lab writeups built over four years of hands-on coursework and self-directed study. Every writeup follows the same format: **overview → environment → walkthrough with real commands and output → skills demonstrated → references**. No filler. No theory-only labs.
...
| **Disk & File Forensics** | FAT16/NTFS/FAT32, MFT analysis, magic byte carving, EXIF extraction, Plaso timelines |
...
|---|---|
| [Sysmon Endpoint Monitoring](blue-team/sysmon-endpoint-monitoring.md) | Deployed + tuned Sysmon with custom XML config; hunted threats via Event IDs 1, 22, 23, 4624/4625 |
...
| [Volatile Evidence Collection](blue-team/volatile-evidence-collection.md) | Live memory acquisition with MAGNET; Velociraptor triage scripts; KAPE targeting MFT, Prefetch, SRUM, Event Logs |
...
| [Network Forensics](blue-team/network-forensics.md) | PCAP analysis with Wireshark + NetworkMiner; credential extraction; file carving from captured sessions |

### 🔴 Red Team
| Writeup | What It Shows |
|---|---|
| [Metasploit & EternalBlue](red-team/metasploit-eternalblue.md) | MS17-010 exploitation; Meterpreter post-exploitation (hashdump, keylogging, remote shell) |
| [OSINT & Intelligence Gathering](red-team/osint-intelligence-gathering.md) | Passive recon with Shodan, SecurityTrails, theHarvester; CVE cross-referencing |
