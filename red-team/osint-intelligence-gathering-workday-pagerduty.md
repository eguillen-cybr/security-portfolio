...
| Employee | Evidence | Employer Confirmation |
|---|---|---|
| Emma Lybrand | LinkedIn profile photo matched Facebook profile | Self-stated Workday employee |
| Ethan Smith | LinkedIn cover photo location matched Facebook | Software Engineer at Workday |
...
| Employee | Role | Evidence | Employer Confirmation |
|---|---|---|---|
| Jennifer Tejada | CEO | LinkedIn profile | Active posts about company projects |
| Kathleen Arnold | CISA/CDPSE — Security role | LinkedIn profile | Role and employer listed |
